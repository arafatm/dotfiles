...
#ZSH_THEME="agnoster"
ZSH_THEME="powerlevel10k/powerlevel10k" # To install git clone --depth=1 https://github.com/romkatv/powerlevel10k.git ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/themes/powerlevel10k
