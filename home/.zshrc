#echo -e "$(date '+%H:%M:%S') enable Powerlevel10k prompt"
...
#echo -e "$(date '+%H:%M:%S') plugins"
ZSH_TMUX_AUTOQUIT=false
plugins=(git ssh-agent tmux)

#echo -e "$(date '+%H:%M:%S') source ohmyzsh"
#echo -e "$(date '+%H:%M:%S') source oh-my-zsh"
...
#echo -e "$(date '+%H:%M:%S') completions"
autoload -U +X bashcompinit && bashcompinit
complete -o nospace -C /home/arafatm/apps/vault vault

#echo -e "$(date '+%H:%M:%S') p10k prompt"
# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh

#echo -e "$(date '+%H:%M:%S') clone p10k"
