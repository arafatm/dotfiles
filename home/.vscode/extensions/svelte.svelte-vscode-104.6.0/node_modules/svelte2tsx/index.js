 ...
 */
function handleComponent(htmlx, str, el, parent) {
 ...
 */
function handleElement(htmlx, str, node, parent) {
...
class ImplicitStoreValues {
    ...
    attachStoreValueDeclarationToImport(node, astOffset, str) {
        ...
        const importStatement = ts__default['default'].isImportClause(node) ? node.parent : node.parent.parent.parent;
...
function svelte2tsx(svelte, options) {
    ...
    if (moduleScriptTag) {
        processModuleScriptTag(str, moduleScriptTag, new ImplicitStoreValues(implicitStoreValues.getAccessedStores()));
    }
    addComponentExport({
        str,
