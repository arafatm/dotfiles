...
Provides syntax highlighting and rich intellisense for Svelte components in VS Code, using the [svelte language server](https://github.com/sveltejs/language-tools/blob/master/packages/language-server).
